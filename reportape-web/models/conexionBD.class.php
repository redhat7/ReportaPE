...
/**
* Clase Padre de conexion a base de datos
*/
class ConexionBD
{
   ...
   public function conectBD()
   {
       ...
       try{        
           ...
           if (self::$pdo == null) {
               	...
               	// Conexion MySql
                    self::$pdo = new PDO(
                       'mysql:dbname=' . BASE_DE_DATOS .';host=' . NOMBRE_HOST . ';',USUARIO,CONTRASENA,array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8")
                    );
                    // Conexion Postgresql
                    /*self::$pdo = new PDO(
